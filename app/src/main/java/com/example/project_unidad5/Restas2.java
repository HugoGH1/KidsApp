...
public class Restas2 extends AppCompatActivity {
    TextView tvNum1, tvNum2,tvmenos,tvigual,tvresult,tvAciertos;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restas2);

        tvNum1 = findViewById(R.id.tvNum1);
        tvNum2 = findViewById(R.id.tvNum2);
        tvmenos = findViewById(R.id.tvresta);
    ...
    public void verificarRespuesta(int respSele, int resultado){
        if(respSele == resultado){
            ...
            if(respCorrec < 15){
                ...
                Intent intent = new Intent(getApplicationContext(),DificultadRestas.class);
